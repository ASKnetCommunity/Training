...
module:
    ...
    res: 'openguides, openhardware_intro, askotecintro, opentech_skills, open_process_documentation, building_open_hardware, ohg_poster'       #comma-separated list e.g. 'askotec', or if more than 1: 'askotec, ohg'
---