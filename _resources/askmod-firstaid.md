---
resource:
    name: '#ASKmod First Aid Set'
    id: 'askmod-firstaid'      #can only contain small letters, numbers, minus and underscore. needs to be the same as the file name
    description: ""
    url: 'https://github.com/opencultureagency/ASKmod-First-Aid-Set'
